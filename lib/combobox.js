...
module.exports = React.createClass({
  ...
  */
  ...
  render: function render() {
    var appearance = this.getAppearance();
    var shrinkStyle = this.props.shrink ? { width: this.state.shrinkWidth + 'px' } : {};
    ...
    return React.createElement(
      ...
      React.createElement('input', {
        ...
        style: _Object$assign({}, shrinkStyle, this.props.inputStyle)
      }),
      React.createElement(
        'div',
        { 'aria-hidden': 'true',
...
function getLabel(component) {
  ...
  return hasLabel ? component.props.label : typeof component.props.children === 'string' ? component.props.children : '';
}
