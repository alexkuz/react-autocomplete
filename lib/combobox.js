...
module.exports = React.createClass({
  ...
  getAppearance: function getAppearance() {
    ...
    appearances['bootstrap-small'] = Object.assign({}, appearances.bootstrap, { input: 'form-control input-sm' });

    appearances['bootstrap-large'] = Object.assign({}, appearances.bootstrap, { input: 'form-control input-lg' });
